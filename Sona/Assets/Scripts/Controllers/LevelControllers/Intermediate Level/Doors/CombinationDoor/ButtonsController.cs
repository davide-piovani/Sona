...
public class ButtonsController : InputListener {

    public Image _img;
    KeyButtonScript _keyButtonScript;
    [SerializeField] ButtonsRowController[] rows;
    bool rowChanged = false;
    int currentRow = 0;

    void Start() {
        _keyButtonScript = FindObjectOfType<KeyButtonScript>();
    ...
    public void StartStringInsert() {
        _img.sprite = _keyButtonScript.GetChangeCharacterButtonImage();
        rows[0].ActiveRow(0);
